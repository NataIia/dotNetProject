...
namespace uuregistration.DataAccessLayer
{
    public class UuregistratieInitialiser : DropCreateDatabaseIfModelChanges<UuregistratieContext>
    {
        protected override void Seed(UuregistratieContext context)
        {
            ...
            UurRegistratieDetails urd1 = new UurRegistratieDetails { StartTijd = new DateTime(2014, 1, 18), EindTijd = new DateTime(2014, 2, 18), TeFactureren = true };
            UurRegistratieDetails urd2 = new UurRegistratieDetails { StartTijd = new DateTime(2015, 1, 18), EindTijd = new DateTime(2015, 2, 18), TeFactureren = false };
