...
namespace uuregistration.Controllers
{
    public class UurRegistratiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Titel,Omschrijving,StartTijd,EindTijd,TypeWerk,TeFactureren")] UurRegistratie uurRegistratie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Titel,Omschrijving,StartTijd,EindTijd,TypeWerk,TeFactureren")] UurRegistratie uurRegistratie)
        {
            if (ModelState.IsValid)
            {
